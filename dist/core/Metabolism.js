...
export class Metabolism {
    ...
    silentPeriod = 30000;
    metabolismInterval = 60000;
    batchSize = 1000;
    constructor(memoryGraph, vectorStore, eventStore) {
    ...
    emitLifecycleEvent(neuron, previousStatus, nextStatus, currentEnergy) {
        if (!this.eventStore)
            return;
    ...
    calculateSM2Energy(stability, repetitions, elapsedDays) {
