...
export type RecallGovernanceSuppressionReason = 'archived' | 'operational_noise' | 'suspect_llm_inference' | 'suspect_external_tool_observation' | 'suspect_unverified_claim' | 'non_recallable_status';
